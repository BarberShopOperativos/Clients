...
void programInit()
{
    ...
    {
        createClient(list->length,specialClientsCounterPtr,*chairsQuantityPtr,*barbersQuantityPtr,CASHIER_QUEUE_SIZE,false,list,chairsQueue,barbersList,cashierQueue,
